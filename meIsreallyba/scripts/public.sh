...
lan_ip="10.66.66"                                  # LAN 地址 别写后面的 .1
wlan_2g_ssid="GOCLOUD"                              # 2G 无线名称
wlan_5g_ssid="GOCLOUD_5G"                           # 5G 无线名称
wlan_guest_2g_ssid="GOCLOUD_Guset"                  # 2G 访客无线名称
wlan_guest_5g_ssid="GOCLOUD_Guest_5G"               # 5G 访客无线名称
wlan_2g_psk="331322960"                            # 2G WIFI密码最少8位 空白为不设置
wlan_5g_psk="331322960"                            # 5G WIFI密码最少8位 空白为不设置
...
echo "修改 LAN IP 地址"
sed -i "s/10.66.66/$lan_ip/g" $default_file
